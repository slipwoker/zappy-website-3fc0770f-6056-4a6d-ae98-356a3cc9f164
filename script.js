document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            const fieldName = input.name || input.getAttribute('data-validate');
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; text-align: center; font-weight: bold;';
                ...
                .catch(function(error) {
                    ...
                    errorMessage.style.cssText = 'color: #dc3545; padding: 1rem; text-align: center;';
    ...
    if (animatedElements.length > 0) {
        ...
        // Handle RTL support for animations
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3fc0770f-6056-4a6d-ae98-356a3cc9f164',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3fc0770f-6056-4a6d-ae98-356a3cc9f164';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3fc0770f-6056-4a6d-ae98-356a3cc9f164';
